...
WidgetTestsWindow::WidgetTestsWindow(const std::string& name, test::TestModule* parent, const std::vector<TestNode*>& required_nodes) : TestModule(name, parent, required_nodes) {
    ...
    test::Test* window_widget_resize_test = addTest("resize", { window_widget_basic_test }, [&](test::Test& test) { windowWidgetResizeTest(test); });
    test::Test* window_widget_chain_test = addTest("chain", { window_widget_children_test, window_widget_resize_test }, [&](test::Test& test) { windowWidgetChainTest(test); });
    test::Test* window_widget_drag_limits_test = addTest("drag_limits", { window_widget_drag_test, window_widget_chain_test }, [&](test::Test& test) { windowWidgetDragLimitsTest(test); });
    test::Test* window_widget_resize_limits_test = addTest("resize_limits", { window_widget_chain_test }, [&](test::Test& test) { windowWidgetResizeLimitsTest(test); });
    test::Test* window_widget_move_to_top_drag_test = addTest("move_to_top_drag", { window_widget_drag_test }, [&](test::Test& test) { windowWidgetMoveToTopDragTest(test); });
    test::Test* window_widget_move_to_top_resize_test = addTest("move_to_top_resize", { window_widget_drag_test, window_widget_resize_test }, [&](test::Test& test) { windowWidgetMoveToTopResizeTest(test); });
}

void WidgetTestsWindow::windowWidgetBasicTest(test::Test& test) {
...
void WidgetTestsWindow::windowWidgetDragTest(test::Test& test) {
    fw::Application application(getWindow());
    application.init(test.name, 800, 600, 0, false);
    application.start(true);
    application.mouseMove(400, 300);
    ...
    WidgetTests::dragWindow(application, window_widget, offset);
    T_VEC2_APPROX_COMPARE(window_widget->getGlobalPosition(), new_position);
}

void WidgetTestsWindow::windowWidgetChildrenTest(test::Test& test) {
    fw::Application application(getWindow());
    application.init(test.name, 800, 600, 0, false);
    application.start(true);
    application.mouseMove(400, 300);
...
void WidgetTestsWindow::windowWidgetResizeTest(test::Test& test) {
    fw::Application application(getWindow());
    application.init(test.name, 800, 600, 0, false);
    application.start(true);
    application.mouseMove(400, 300);
...
void WidgetTestsWindow::windowWidgetChainTest(test::Test& test) {
    fw::Application application(getWindow());
    application.init(test.name, 800, 600, 0, false);
    application.start(true);
    application.mouseMove(400, 300);
...
void WidgetTestsWindow::windowWidgetDragLimitsTest(test::Test& test) {
    fw::Application application(getWindow());
    application.init(test.name, 800, 600, 0, false);
    application.start(true);
    application.mouseMove(400, 300);
...
void WidgetTestsWindow::windowWidgetResizeLimitsTest(test::Test& test) {
    fw::Application application(getWindow());
    application.init(test.name, 800, 600, 0, false);
    application.start(true);
    application.mouseMove(400, 300);
    ...
    // making window smaller than minimum size
    {
        ...
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::TOP_LEFT, sf::Vector2f(child_width, child_height));
    ...
    }
    {
        ...
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::TOP, sf::Vector2f(0.0f, child_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // top right
        ...
        sf::Vector2f new_size = sf::Vector2f(min_size.x, min_size.y + child_header_height);
        sf::FloatRect new_bounds = sf::FloatRect(child_window->getBottomLeft() + sf::Vector2f(0.0f, -new_size.y), new_size);
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::TOP_RIGHT, sf::Vector2f(-child_width, child_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // left
        ...
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::LEFT, sf::Vector2f(child_width, 0.0f));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // right
        ...
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::RIGHT, sf::Vector2f(-child_width, 0.0f));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // bottom left
        ...
        sf::Vector2f new_size = sf::Vector2f(min_size.x, min_size.y + child_header_height);
        sf::FloatRect new_bounds = sf::FloatRect(child_window->getTopRight() + sf::Vector2f(-new_size.x, 0.0f), new_size);
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::BOTTOM_LEFT, sf::Vector2f(child_width, -child_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // bottom
        ...
        sf::Vector2f new_size = sf::Vector2f(child_width, min_size.y + child_header_height);
        sf::FloatRect new_bounds = sf::FloatRect(child_window->getTopLeft(), new_size);
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::BOTTOM, sf::Vector2f(0.0f, -child_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // bottom right
        ...
        sf::Vector2f new_size = sf::Vector2f(min_size.x, min_size.y + child_header_height);
        sf::FloatRect new_bounds = sf::FloatRect(child_window->getTopLeft(), new_size);
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::BOTTOM_RIGHT, sf::Vector2f(-child_width, -child_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    ...
    // resizing past parent window borders
    {
        ...
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::TOP_LEFT, sf::Vector2f(-parent_width, -parent_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // top right
        ...
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::TOP_RIGHT, sf::Vector2f(parent_width, -parent_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // bottom left
        ...
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::BOTTOM_LEFT, sf::Vector2f(-parent_width, parent_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // bottom right
        ...
        WidgetTests::resizeWindow(child_window, WidgetTests::ResizePoint::BOTTOM_RIGHT, sf::Vector2f(parent_width, parent_height));
        T_COMPARE(child_window->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
}
...
void WidgetTestsWindow::windowWidgetMoveToTopDragTest(test::Test& test) {
    ...
    WidgetTests::dragWindow(application, window_1_widget, sf::Vector2f(window_width, 0.0f));
    ...
    WidgetTests::dragWindow(application, window_2_widget, sf::Vector2f(window_width, 0.0f));
...
void WidgetTestsWindow::resizeWindowTest(fw::Application& application, test::Test& test, fw::WindowWidget* widget) {
...

    {
        ...
        WidgetTests::resizeWindow(widget, WidgetTests::ResizePoint::TOP_LEFT, resize_offset);
    ...
    }
    {
        ...
        WidgetTests::resizeWindow(widget, WidgetTests::ResizePoint::TOP, resize_offset);
        T_COMPARE(widget->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // top right
        ...
        WidgetTests::resizeWindow(widget, WidgetTests::ResizePoint::TOP_RIGHT, resize_offset);
        T_COMPARE(widget->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // left
        ...
        WidgetTests::resizeWindow(widget, WidgetTests::ResizePoint::LEFT, resize_offset);
        T_COMPARE(widget->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // right
        ...
        WidgetTests::resizeWindow(widget, WidgetTests::ResizePoint::RIGHT, resize_offset);
        T_COMPARE(widget->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // bottom left
        ...
        WidgetTests::resizeWindow(widget, WidgetTests::ResizePoint::BOTTOM_LEFT, resize_offset);
        T_COMPARE(widget->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // bottom
        ...
        WidgetTests::resizeWindow(widget, WidgetTests::ResizePoint::BOTTOM, resize_offset);
        T_COMPARE(widget->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
    {
        // bottom right
        ...
        WidgetTests::resizeWindow(widget, WidgetTests::ResizePoint::BOTTOM_RIGHT, resize_offset);
        T_COMPARE(widget->getParentLocalBounds(), new_bounds, &WidgetTests::floatRectToStr);
    }
}

...
private:
	...
	static sf::Vector2f screen_to_world(const sf::Vector2f& screen_pos);
	static sf::Vector2f pixel_to_world(const sf::Vector2i& screen_pos);
	static sf::Vector2f world_to_screen(const sf::Vector2f& world_pos);
	static sf::Vector2f world_to_screen(const b2Vec2& world_pos);
	static sf::Vector2i world_to_pixel(const sf::Vector2f& world_pos);
	static sf::Vector2i world_to_pixel(const b2Vec2& world_pos);
	static sf::Vector2f world_dir_to_screenf(const b2Vec2& world_dir);
